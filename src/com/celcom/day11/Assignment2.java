...
//		{
//			int num = Integer.valueOf(code.substring(i,i+2));
//			if(i!=0 && code.charAt(i)=='0' && Integer.valueOf(code.substring(i-1,i+1))>26)
//			{
//				System.out.println("Not Possible");
//				return;
//			}
//			if(code.charAt(i)!='0' && num<=26)
//			{
//				total+=2;
//			}
//			else
...
//			total++;
//		}
//		System.out.println("Total Possible Outcomes Are : " + (total-code.length()+1));
//		
	}
